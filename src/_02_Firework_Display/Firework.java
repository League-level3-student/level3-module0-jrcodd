...
public class Firework {
	...
	public Firework() {
		...
		for (int i = 0; i < sparkArray.length; i++) {
			sparkArray[i] = new Spark(720 / 2, 480);
		}
	}
	...
	public void drawSparks(Graphics g) {
		...
		for (int i = 0; i < sparkArray.length; i++) {
			...
			g.fillOval(sparkArray[i].x, sparkArray[i].y, 10, 10);
		}
	}
}
